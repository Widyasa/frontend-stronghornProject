  ...
  <div class="px-5 pt-5 mb-5">
    <div class="d-flex flex-column">
      <div class="d-flex flex-row justify-content-between">
        <p class="title-font fs-3 text-uppercase">USER MEMBERSHIP DATA</p>
      </div>
      <div class="mt-4">
        <div class="card-dashboard-wrapper p-4">
          <table class="table w-100">
            ...
            <tr v-for="(item, index) in paginatedData2" :key="index">
              ...
              <td class="">
                <button class="btn btn-color" @click="showModalEdit(item)">
                 Rent
                </button>
              </td>
              <td class="d-flex flex-row gap-2">
                <router-link :to="{name:'userDetail'}" class="btn border-0 p-0">
