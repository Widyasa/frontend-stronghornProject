<template>
  <div class="px-5 pt-5 mb-5">
    ...
    <div class="d-flex flex-column mt-5">
      <div class="d-flex flex-row justify-content-between">
        ...
        <button class="btn btn-color" @click="showModalAdd">Add Achievement</button>
      </div>
      <div class="mt-4">
        <div class="card-dashboard-wrapper p-4">
          <table class="table">
            ...
            <tr v-for="(achievement, index) in paginatedData2" :key="index">
              ...
              <td><img :src="achievement.icon" alt=""></td>
  ...
  <modal-component title="Add Achievement" modal-id="addModalAchievement" >
    <hr class="hr-form mt-4">
    <form class="modal-form-wrapper d-flex flex-column gap-4 mt-2">
      <div class="d-flex flex-row justify-content-between">
        <div class="d-flex flex-column">
      ...
      <div class="d-flex flex-column">
        <p class="input-title">Achievement Icon</p>
        <input type="text" class="form-input">
      </div>
      <div class="d-flex flex-column">
        <p class="input-title">Achievement Description</p>
        <input type="text" class="form-input">
      </div>
    </form>
    <hr class="hr-form mt-4">
    <div class="d-flex flex-row mt-2 justify-content-end gap-3">
      <button class="btn btn-close-modal">Cancel</button>
      <button class="btn btn-color-modal">Add Achievement</button>
    </div>
  </modal-component>
  <modal-component title="Edit Achievement" modal-id="editModalAchievement" >
    <hr class="hr-form mt-4">
    <form class="modal-form-wrapper d-flex flex-column gap-4 mt-2">
      <div class="d-flex flex-row justify-content-between">
        <div class="d-flex flex-column">
  ...
  <delete-modal title="Delete Achievement Table" modal-id="deleteModal">
    <hr class="hr-form">
    <p class="delete-desc fw-medium">
      Are you sure you want to delete this Achievement table? The process cannot be undo
    </p>
    <hr class="hr-form">
    <div class="d-flex flex-row mt-2 justify-content-end gap-3">
      <button class="btn btn-close-modal">Cancel</button>
      <button type="button" class="btn btn-danger-modal">Delete Achievement</button>
    </div>
  </delete-modal>
</template>
...
export default {
  ...
  data(){
    return {
      ...
      achievements: [
        {id:1, no:1, icon:"/img/table/service-icon.svg" , number:"100+", description:"expert coach"}
      ],
      modalStatus: false,
      idAchievement:''
    }
  ...
  methods: {
    ...
    showModalAdd(){
      ...
      $("#addModalAchievement").modal("show");
    },
    showModalEdit(achievement){
      this.modalStatus=true
      $("#editModalAchievement").modal("show");
